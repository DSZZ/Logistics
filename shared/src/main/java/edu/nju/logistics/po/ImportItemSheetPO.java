...
public class ImportItemSheetPO extends SheetPO{
	...
	public ImportItemSheetPO(String id, String employeeID, String type, String date, String state, String description,
