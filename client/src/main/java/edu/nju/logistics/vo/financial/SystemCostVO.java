...
public class SystemCostVO {
	 ...
	 */
     private ArrayList<UserInfoVO>  userInfoList;
       ...
       * 用于显示的机构运费、租金信息列表
       */
     private ArrayList<InstiInfoVO> InstiInfoList;
      
     public   SystemCostVO(ArrayList<UserInfoVO>  userInfoList,ArrayList<InstiInfoVO> InstiInfoList,double [] totalFee,String []date  ){
//             userInfoList=new ArrayList<UserInfoVO>();
//        	 InstiInfoList= new ArrayList<InstiInfoVO>();
        	 ...
        	 this.setDate(date);
        	 System.out.println("systemcostvo 构造方法完成: userinfoListsize:"+this.userInfoList.size()+"instiInfoListsize : "+this.InstiInfoList.size());
        }
		...
		public ArrayList<InstiInfoVO> getInstiInfoList() {
			return this.InstiInfoList;
		}
		
		public void setInstiInfoList(ArrayList<InstiInfoVO> instiInfoList) {
			this.InstiInfoList = instiInfoList;
		}
